      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-slate-400 text-sm">Simple invoicing for freelancers and small businesses.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/register" className="text-slate-400 hover:text-white transition-colors text-sm">Get Started</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-slate-500 text-sm">© 2026 InvoiceApp. All rights reserved.</div>
